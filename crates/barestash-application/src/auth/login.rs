...
use barestash_domain::StoredCredential;
use barestash_infrastructure::browser::open_browser;
use barestash_infrastructure::credentials::CredentialWriteResult;
use barestash_infrastructure::terminal::read_stdin_to_string;
use barestash_presentation::{AuthLoginView, print_auth_login, sanitize_terminal_text};
...
use crate::command::AuthLoginArgs;
use crate::{AppContext, CliError};

use super::{
    add_seconds_iso, clear_legacy_config_token, revoke_cli_session_best_effort,
